🍽️ Mora Food – Front-End Food Application

Mora Food is a responsive front-end food application developed using HTML, CSS, and JavaScript. The project focuses on delivering a clean and user-friendly interface for browsing food options, managing user profiles, and handling basic app interactions on the client side.
...
Suitable for UI/UX demonstration and practice
...
Open any .html file (e.g., Main.html) in a browser
